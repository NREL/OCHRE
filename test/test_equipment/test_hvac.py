...
from ochre.Equipment.HVAC import (
    HVAC, Heater, Cooler,
    ElectricFurnace, ElectricBoiler, ElectricBaseboard,
    GasFurnace, GasBoiler,
    DynamicHVAC, AirConditioner, RoomAC, ASHPCooler,
    HeatPumpHeater, ASHPHeater,
    MinisplitHVAC, MinisplitAHSPCooler, MinisplitAHSPHeater,
)
...
class HVACControlTestCase(unittest.TestCase):
    ...
    def test_external_control_setpoint(self):
        ...
        self.assertAlmostEqual(
            self.heater.current_schedule['HVAC Heating Setpoint (C)'], 25
        )
