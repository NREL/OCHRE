...
def interpolate_to_odb_table_point(detailed_performance_data, property, target_odb): # removed capacity description as an input our property/capacity description are together (max cop / min capacity)
