...
#site_number = '11531' #90023 #10292#'10441'
    ...
    simulation_days = 100#200#220 #172 #220 #remove two weeks
    ...
    interval = int(len(raw_data)*0.5) #Startpoint for testing data
    train_end = interval
    ...
    for s in setpoint_range: #run simulation for every setpoint in valid range
        ...
        to_save = to_save[:-1] 
        to_save.to_csv(f'output_site_{site_number}_bisectioncontrol_ud_{bisection_temp}_{water_nodes}_rolling avg.csv', header=True, index=False)