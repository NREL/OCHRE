...
dwelling_args = {
    'name': 'Meritage_Alexander',  # simulation name
    ...
    'initialization_time': dt.timedelta(days=3),  # used to create realistic starting temperature
    ...
    'hpxml_file': os.path.join('C:/Users/jmaguire/Desktop/IBACOS/OCHRE_Inputs/base_model','Meritage_Alexander.xml'),
    'schedule_input_file': os.path.join('C:/Users/jmaguire/Desktop/IBACOS/OCHRE_Inputs/base_model','Meritage_Alexander_schedules.csv'),
    ...
    'output_path': 'C:/Users/jmaguire/Desktop/IBACOS/OCHRE_outputs/Alexander',           # defaults to hpxml_file path
