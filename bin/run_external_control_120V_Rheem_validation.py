...
temp_data = pd.read_csv(f'ochre\\defaults\\Input Files\\Temperature Values\\{ambient_temp}F_24hour_shared.csv')
start_date = dt.datetime(2021, 9, 13, 8, 42) #site_1 at 4am
...
equipment_args = {
    ...
    "duration": dt.timedelta(minutes= 147),
